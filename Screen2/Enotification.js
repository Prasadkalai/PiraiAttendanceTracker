...
Alert,    StatusBar 
    ...
    class Enotification extends Component{
      ...
      <Card containerStyle={{}}>
            ...
            <View style={{paddingLeft:20,flexDirection:'column',justifyContent:'space-between'}}>
            <Icon  iconStyle={{color:'green',}} name={'check'} size={25} onPress={() => Alert.alert('approved')} />
            <Icon  iconStyle={{color:'red',}} name={'close'} size={25} onPress={() => Alert.alert('declined')} />
                          </View>
                          </ View>
          </Card>
          <Card containerStyle={{}}>
